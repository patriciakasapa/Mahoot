    ...
    ***************************************************************************** */
    ...
    var MicrosoftLoginProvider = /** @class */ (function (_super) {
        ...
        function MicrosoftLoginProvider(clientId, initOptions) {
            if (initOptions === void 0) { initOptions = defaultOptions; }
            var _this = _super.call(this) || this;
            _this.clientId = clientId;
            _this.initOptions = initOptions;
            return _this;
                    ...
                    try {
                        var config = {
                            auth: {
                                ...
                                redirectUri: (_a = _this.initOptions.redirect_uri) !== null && _a !== void 0 ? _a : defaultOptions.redirect_uri,
                                authority: (_b = _this.initOptions.authority) !== null && _b !== void 0 ? _b : defaultOptions.authority,
                                knownAuthorities: (_c = _this.initOptions.knownAuthorities) !== null && _c !== void 0 ? _c : defaultOptions.knownAuthorities,
                                protocolMode: (_d = _this.initOptions.protocolMode) !== null && _d !== void 0 ? _d : defaultOptions.protocolMode,
                                clientCapabilities: (_e = _this.initOptions.clientCapabilities) !== null && _e !== void 0 ? _e : defaultOptions.clientCapabilities
                            },
                            cache: !_this.initOptions.cacheLocation ? null : {
                                cacheLocation: (_f = _this.initOptions.cacheLocation) !== null && _f !== void 0 ? _f : defaultOptions.cacheLocation
                            }
                        };
